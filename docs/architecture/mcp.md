...
uncertain and is never converted into an automatic execution retry. Unkeyed
internal callers remain supported during the migration, including the legacy
lost-wave reconciliation used for their batch accounting.
